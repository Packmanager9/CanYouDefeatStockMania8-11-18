...
import ditzler.cole.myapplication2.feature2.DiceGame;
import ditzler.cole.myapplication2.feature2.R;
import ditzler.cole.myapplication2.feature2.gumbler;
...
*/
             //   graph.setVisibility(View.INVISIBLE);
                ...
                if (GraphsON == 1) {
                    IndicatorDot.setColorFilter(android.graphics.Color.parseColor("#cc0000"));
                    graph0.setVisibility(View.INVISIBLE);
                //    graph1.setVisibility(View.VISIBLE);
                }else if (GraphsON == 2) {
                    graph1.setVisibility(View.INVISIBLE);
                 //   graph1.setVisibility(View.VISIBLE);
                    IndicatorDot.setColorFilter(android.graphics.Color.parseColor("#ff7722"));
                }else if (GraphsON == 3) {
                    IndicatorDot.setColorFilter(android.graphics.Color.parseColor("#ccaa00"));
                    graph2.setVisibility(View.INVISIBLE);
                 //   graph3.setVisibility(View.VISIBLE);
                }else if (GraphsON == 4) {
                    IndicatorDot.setColorFilter(android.graphics.Color.parseColor("#00aa00"));
                    graph3.setVisibility(View.INVISIBLE);
                //    graph4.setVisibility(View.VISIBLE);
                }else if (GraphsON == 5) {
                    IndicatorDot.setColorFilter(android.graphics.Color.parseColor("#0099aa"));
                    graph4.setVisibility(View.INVISIBLE);
                 //   graph5.setVisibility(View.VISIBLE);
                }else if (GraphsON == 6) {
                    IndicatorDot.setColorFilter(android.graphics.Color.parseColor("#0000ff"));
                    graph5.setVisibility(View.INVISIBLE);
                   // graph6.setVisibility(View.VISIBLE);
                }else if (GraphsON == 7) {
                    IndicatorDot.setColorFilter(android.graphics.Color.parseColor("#AA00ff"));
                    graph6.setVisibility(View.INVISIBLE);
                 //   graph7.setVisibility(View.VISIBLE);
                }else if (GraphsON == 8) {
                    IndicatorDot.setColorFilter(android.graphics.Color.parseColor("#999999"));
                    graph7.setVisibility(View.INVISIBLE);
                 //   graph0.setVisibility(View.VISIBLE);
                }else {
                    IndicatorDot.setColorFilter(android.graphics.Color.parseColor("#FFFFFF"));
                  //  graph0.setVisibility(View.INVISIBLE);
                }
...
*/
        ...
        seriez.setSize(4);
        seriez.setColor(android.graphics.Color.parseColor("#090909"));
        serien = new PointsGraphSeries<>(dataantichecker());
        serien.setSize(4);
        serien.setColor(android.graphics.Color.parseColor("#909090"));
